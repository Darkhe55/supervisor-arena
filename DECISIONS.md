...
| ID | 名称 | 倾向 |
|----|------|------|
| H-1 | 后端语言 | Node.js / Python / Go / Rust |
| H-2 | 数据库 | PostgreSQL |
| H-3 | 存储(证据附件) | 不入库,仅 URL(配合证据形式) |
| H-4 | 搜索引擎 | Postgres FTS |
| H-5 | 前端框架 | React / Vue / Svelte / 纯 HTML |
| H-6 | 部署 | Vercel / 自托管 / Cloudflare |
| H-7 | 监控 | 无(Sentry 备选) |
| H-8 | 邮件服务 | 不发送邮件(初期) |
| H-9 | CI/CD | GitHub Actions |
| H-10 | 支付渠道 | Stripe / 支付宝 / 微信 |
...
| I-2 | 推广 | 倾向:学术社区 |
| I-3 | 不做"机构"层 | ☑ |
| I-4 | 学术合作 | 倾向:接受非商业学术研究 |
| I-5 | 国际化 = 中英双语 | ☑ |
| I-6 | 公开 API | 倾向:开放只读 API |
